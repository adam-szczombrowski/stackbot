 ...
 /**
  ...
  listen(port, token) {
    ...
    dispatcher.onGet("/", function(req, res) {
      ...
      let html = '<h1>Slack Slash Command Handler</h1><p>This project demonstrates responding to Slash commands in Slack, using StackExchange API to look for questions on StackOverflow.</p><p>To test it out:</p><br /><a id="add-to-slack" href="https://slack.com/apps/A0F82E8CA-slash-commands"><img alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a><footer id="gWidget"></footer><script src="https://widget.gomix.me/widget.min.js"></script>';
      res.end(html);
    });     
